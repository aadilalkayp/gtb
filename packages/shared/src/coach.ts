...
export const COACH_STARTER_ARTICLES: StarterArticle[] = [
  ...
  {
    title: "Even skin tone before the big day",
    category: "skin",
    tags: ["tone", "pigmentation", "dark spots", "sunscreen", "vitamin c"],
    content: `${P}Tone evenness is a 6-8 week project: daily sunscreen is the whole game; a vitamin C serum in the morning and gentle exfoliation twice a week support it. No new strong actives in the final three weeks. Avoid aggressive treatments within 14 days of the big day.`,
  },
  {
  ...
  {
    title: "Big day haircut timing",
    category: "hair",
    tags: ["haircut", "timing", "trial", "barber"],
    content: `${P}Trial the exact cut you want 4-6 weeks out so the barber knows the brief. Final cut 4-6 days before the big day: sharp enough to look intentional, softened enough to not look fresh. Never try a new style the week of.`,
  },
  {
    title: "Scalp and hair health",
    category: "hair",
    tags: ["scalp", "oil", "wash", "shine", "density"],
    content: `${P}Wash on alternate days with a gentle shampoo; oil or scalp treatment twice a week; conditioner on lengths only. Density changes take months, so focus on shine, neatness and the right cut.`,
  },
  {
    title: "Beard shaping and maintenance",
    category: "beard",
    tags: ["beard", "neckline", "cheek line", "oil", "trim"],
    content: `${P}Define the neckline two fingers above the Adam's apple; keep cheek lines natural. Oil daily, comb daily, trim weekly. Decide your big day beard shape at least 4 weeks out and maintain it. No experiments in the final month. Final shape-up 4-6 days before.`,
  },
  {
  ...
  },
  {
    ...
    content: `${P}T-30 outfit trial; T-21 shoes and accessories; T-14 last deep facial (never closer); T-10 fragrance and grooming kit; T-7 documents; T-5 final haircut and beard; T-3 pack and prepare; T-1 rest, hydrate, early night.`,
  },
  {
    title: "How the readiness score works",
    category: "general",
    tags: ["score", "readiness", "rescan", "progress", "fitness score", "confidence"],
    content: `Your Big Day Readiness blends appearance (skin, hair, beard/brows, style from your photos), self-reported fitness and confidence, and how many roadmap tasks you've completed on time. Rescan monthly, same angle and same light, to see your own progress. Scores rate appearance only and are never a medical assessment.`,
  },
  {
    title: "Talking to a GTB coach",
    category: "general",
    tags: ["program", "coach", "consultation", "price", "book", "call"],
    content: `${P}The GTB program pairs you with skincare, fitness and styling consultants who run your plan with you all the way to your big day. To talk to a human coach, reply to any GTB email or ask here and we'll arrange a call. The assistant can't quote prices or book sessions.`,
  },
];
